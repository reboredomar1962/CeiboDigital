                ...
                <View style={styles.container}>
                    ...
                    {me.myPlans.map(plan => (
                        ...
                        <View key={plan.id} style={styles.cardContainer}>
                            ...
                            <View>
                                <Text style={styles.dateTxt}>{plan.planDate.substring(8,10)}</Text>
                            </View>
                            <View>
                                <Text style={styles.dateTxt}>{
                                        plan.planDate.substring(5,7) === '01' ? 'Ene' : 
                                        plan.planDate.substring(5,7) === '02' ? 'Feb' :
                                        plan.planDate.substring(5,7) === '03' ? 'Mar' :
                                        plan.planDate.substring(5,7) === '04' ? 'Abr' :
                                        plan.planDate.substring(5,7) === '05' ? 'May' :
                                        plan.planDate.substring(5,7) === '06' ? 'Jun' :
                                        plan.planDate.substring(5,7) === '07' ? 'Jul' :
                                        plan.planDate.substring(5,7) === '08' ? 'Aug' :
                                        plan.planDate.substring(5,7) === '09' ? 'Sep' :
                                        plan.planDate.substring(5,7) === '10' ? 'Oct' :
                                        plan.planDate.substring(5,7) === '11' ? 'Nov' :
                                        plan.planDate.substring(5,7) === '12' ? 'Dec' : '?' 
                                }</Text>
                            </View>
                            </View>
