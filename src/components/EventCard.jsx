...
const EventCard = () => (
  <Card style={{width: 300, marginTop: 15}}>
    ...
    <Card.Content style={{marginTop:10}}>
      <Title style={{fontFamily: 'Poppins_500Medium', fontSize: 20, color: '#23036A'}} >Personal Fest</Title>
      <Paragraph style={{fontFamily: 'Poppins_300Light', fontSize: 15, color: '#23036A'}} >Conseguí tus entradas acá</Paragraph>
    </Card.Content>
  </Card>
);
